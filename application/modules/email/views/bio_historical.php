                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;" align="justify">Berikut kami informasikan bahwa user <strong><?= $user_uploader; ?></strong> telah melakukan Publish Master Biomasa Historical pada aplikasi <strong>P2EP DATASTORE</strong> dengan detail sebagai berikut:</p>
