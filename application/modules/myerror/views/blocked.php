                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-5 ms-auto">
                                                <div class="ex-page-content">
                                                    ...
                                                    <h3 class="mb-0">Forbidden.</h3>
                                                    <p class="mb-5">Maaf, anda tidak berhak mengakses halaman ini.<br>Silahkan hubungi administrator.</p>
                                                    <a class="btn btn-primary mb-5 waves-effect waves-light" href="<?= base_url('home'); ?>"><i class="ti ti-home me-1"></i> Back to Home</a>
                                                </div>

                                            </div>
                                            <div class="col-lg-5 mx-auto">
                                                <img src="<?= base_url('public/error/403.jpg'); ?>" alt="" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                                    </div><!-- end cardbody -->
                                </div><!-- end card -->
