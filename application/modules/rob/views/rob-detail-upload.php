    ...
    <div id="layout-wrapper">
                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="float-end d-none d-md-block">
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-warning waves-effect waves-light" type="button" onclick="window.location.href = '<?= base_url('rob/upload'); ?>';">
                                    ...
                                    <div class="card-body border-bottom border-1">
                                        <dl class="row mb-0">
                                            ...
                                            <?php if ($file['STATUS'] == "INIT") : ?>
                                                ...
                                                <dd class="col-sm-10">
                                                    <a href="<?= base_url('rob/exe_upload/') . encrypt_url($file['ID']); ?>" type="button" class="btn btn-primary btn-sm waves-effect" onclick="return confirmPublish()"><i class="ion ion-ios-save me-1"></i>Eksekusi Data</a>
                                                </dd>
                                            <?php endif; ?>
                                        </dl>
                                    </div>
                                            ...
                                            <div class="tab-pane active table-responsive p-3" id="excel" role="tabpanel">
                                                <table class="table mb-0">
                                                    <thead>
                                                        ...
                                                        <th class="text-center">
                                                            <smalls>Rencana Pembebanan</smalls>
                                                        </th>
                                                        <th class="text-center" style="white-space: nowrap;">
                                                            <smalls>CF (%)</smalls>
                                                        </th>
                                                        <th class="text-center">
                                                            <smalls>Merit Order</smalls>
                                                        </th>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($log as $f) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <smalld><?= bulan2($f['BULAN']); ?></smalld>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <smalld><?= $f['TAHUN']; ?></smalld>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <smalld><?= $f['RENCANA_PEMBEBANAN']; ?></smalld>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <smalld><?= $f['CF']; ?></smalld>
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <smalld><?= $f['MERIT_ORDER']; ?></smalld>
                                                                    </td>
                                                                    <td class="text-center">
        ...
        <script>
            function confirmPublish() {
                return confirm("Apakah anda yakin untuk mengeksekusi data ini?")
            }
        </script>
</body>
