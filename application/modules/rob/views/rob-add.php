                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center mb-2">
                            <div class="col-md-8">
                                ...
                                <p class="card-text">#Add Data <?= $ptitle; ?> Bulanan</p>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('rob/add'); ?>" enctype="multipart/form-data">
                                            <?= csrf(); ?>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 offset-sm-2 col-form-label">File ROB</label>
                                                <div class="col-sm-6">
                                                    <input type="file" name="rob" class="filestyle <?= form_error('rob', 'is-invalid '); ?>" data-buttonname="btn-secondary" required>
                                                    <?= form_error('rob', '<div class="invalid-feedback">', '</div>'); ?>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="mb-3 row">
                                            ...
                                            <p class="mb-3 font-14">
                                                ...
                                                4. Kolom <span class="text-primary"><strong>PERIODE BULAN</strong></span> diisi dengan menggunakan <span class="text-primary"><strong>ANGKA</strong></span> bukan <span class="text-danger"><strong>KARAKTER</strong></span>
                                            </p>
                                        </form>
                                    </div>
                                </div>
