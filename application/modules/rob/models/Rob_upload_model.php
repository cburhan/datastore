<?php
class Rob_upload_model extends CI_Model
{
    ...
    {
        $this->db->insert('rob_upload', $data);
    ...
    {
        $update = $this->db->update('rob_upload', $data, array('ID' => $file_id));
        return $update;
    }
    ...
    {
        $this->db->insert('rob_upload_log', $data_log);
    }

    public function get_not_kit($kode, $bulan, $tahun)
    {
