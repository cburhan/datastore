                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center mb-2">
                            <div class="col-md-8">
                                ...
                                <p class="card-text">#Detail Data <?= $ptitle; ?> Mingguan</p>
                            </div>
                            <div class="col-md-4">
                                                    ...
                                                    <?php foreach ($sheet as $f) : ?>
                                                        <?php if ($s > 1) : ?>
                                                            <tr>
                                                                ...
                                                                <td class="p-1 text-center">
                                                                    <?php if ($f['E'] != NULL) { ?>
                                                                        <?php $start = date('Y-m-d', strtotime(str_replace('.', '/', $f['E']))); ?>
                                                                        <smalls><?= tgl_indo($start); ?></smalls>
                                                                    <?php } else { ?>
                                                                        <smalls><span class="text-danger">No data</span></smalls>
                                                                    <?php } ?>
                                                                </td>
                                                                <td class="p-1 text-center">
                                                                    <?php if ($f['F'] != NULL) { ?>
                                                                        <?php $end = date('Y-m-d', strtotime(str_replace('.', '/', $f['F']))); ?>
                                                                        <smalls><?= tgl_indo($end); ?></smalls>
                                                                    <?php } else { ?>
                                                                        <smalls><span class="text-danger">No data</span></smalls>
                                                                    <?php } ?>
                                                                </td>
