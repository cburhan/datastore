                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('pembangkit/add'); ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" name="kode" class="form-control <?= form_error('kode', 'is-invalid '); ?>" placeholder="Kode Pembangkit" value="<?= set_value('kode'); ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="nama" class="form-control <?= form_error('nama', 'is-invalid '); ?>" placeholder="Nama Pembangkit" value="<?= set_value('nama'); ?>">
