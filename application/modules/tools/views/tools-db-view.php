                ...
                <div class="container-fluid">
                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center mb-2">
                            ...
                            <?php if (check_button('add_backup_db') > 0) {
                            ?>
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-primary" type="button" onclick="window.location.href = '<?= base_url('tools/add_backup_db'); ?>';">
                                        ...
                                        <table id="mytable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Created By</th>
                                                    <th>Created On</th>
                                                    <?php if (check_button('download_backup_db') > 0) { ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#mytable').DataTable({
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?php echo site_url('tools/get_data_backup'); ?>",
                        "type": "POST"
                    },
                    'columnDefs': [{
                        "targets": [0, 3],
            ...
            function confirmDownload() {
                return confirm("Apakah anda yakin untuk mendownload Backup DB?")
            }
        </script>
</body>
