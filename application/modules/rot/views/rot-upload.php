                                                ...
                                                <?php if ($file != NULL) { ?>
                                                    ...
                                                    <?php foreach ($file as $f) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center align-middle">
                                                                <a href="<?= base_url('rot/detail_upload/') . encrypt_url($f['ID']); ?>" class="btn btn-info btn-sm waves-effect"><i class="ion ion-md-eye"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                <?php } else { ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<?= base_url('rot/do_upload/'); ?>" enctype="multipart/form-data">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                                <div class="row mb-3">
                                    <label class="col-sm-2 offset-sm-1 col-form-label">Template</label>
                                    <div class="col-sm-8">
                                        <button type="button" class="btn btn-sm btn-info" onclick="window.location.href = '<?= base_url('rot/download_template'); ?>';"><i class="ion ion-md-download me-1"></i>Download</button>
                                    </div>
                                </div>
                                <div class="row mb-3">
