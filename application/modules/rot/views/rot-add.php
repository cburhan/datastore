                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center mb-2">
                            <div class="col-md-8">
                                ...
                                <p class="card-text">#Add Data <?= $ptitle; ?> Tahunan</p>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('rot/add'); ?>" enctype="multipart/form-data">
                                            <?= csrf(); ?>
                                            <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 offset-sm-2 col-form-label">File ROT</label>
                                                <div class="col-sm-6">
                                                    <input type="file" name="rot" class="filestyle <?= form_error('rot', 'is-invalid '); ?>" data-buttonname="btn-secondary" required>
                                                    <?= form_error('rot', '<div class="invalid-feedback">', '</div>'); ?>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="mb-3 row">
