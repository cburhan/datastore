...
class Bio_master extends MY_Controller
{
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $subject = 'Data Biomasa Master ' . $tipe_text;
            $data_email = array(
                "modul"     => "BIOMASA",
                "modul_id"  => $add_id,
                "tipe"      => $tipe_text,
                ...
                "time"      => $time,
                "color"     => "succcess",
                "url"       => "bio_master/detail/" . encrypt_url($add_id)
            );
            ...
            send_notification(get_session_id(), $data_email, $subject, 'email/bio_master', $message);
