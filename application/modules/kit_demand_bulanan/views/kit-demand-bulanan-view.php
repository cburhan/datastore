                            ...
                            <div class="col-md-4">
                                <div class="float-end d-none d-md-block">
                                    <div class="dropdown">
                                        ...
                                        ?>
                                            <button class="btn btn-sm btn-success" type="button" onclick="window.location.href = '<?= base_url('kit_demand_bulanan/publish'); ?>';">
                                        ...
                                        ?>
                                            <button class="btn btn-sm btn-primary" type="button" onclick="window.location.href = '<?= base_url('kit_demand_bulanan/upload'); ?>';">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                table = $('#mytable').DataTable({
                    ...
                    "pageLength": 20,
                    "ajax": {
                        "url": "<?= site_url('kit_demand_bulanan/get_data'); ?>",
                        "type": "POST"
                    },
                    'columnDefs': [{
                        "targets": [0, 4, 5, 6, 7],
