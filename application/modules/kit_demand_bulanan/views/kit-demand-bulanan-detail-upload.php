                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="float-end d-none d-md-block">
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-outline-warning waves-effect waves-light" type="button" onclick="window.location.href = '<?= base_url('kit_demand_bulanan/upload'); ?>';">
                                    ...
                                    <div class="card-body border-bottom border-1">
                                        <dl class="row mb-0">
                                            ...
                                            <?php if ($file['STATUS'] == "INIT") : ?>
                                                ...
                                                <dd class="col-sm-10">
                                                    <a href="<?= base_url('kit_demand_bulanan/exe_upload/') . encrypt_url($file['ID']); ?>" type="button" class="btn btn-primary btn-sm waves-effect"><i class="ion ion-ios-save me-1"></i>Eksekusi Data</a>
                                                </dd>
                                            <?php endif; ?>
                                        </dl>
                                    </div>
