                            ...
                            ?>
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-primary" type="button" onclick="window.location.href = '<?= base_url('user/add'); ?>';">
                                        ...
                                        <table id="mytable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Username</th>
                                                    <th>Role</th>
                                                    <?php if (check_button('detail') > 0 || check_button('edit') > 0 || check_button('delete') > 0) {
                                                    ?>
