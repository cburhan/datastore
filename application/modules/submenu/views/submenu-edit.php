                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('submenu/edit/') . encrypt_url($submenu['ID']); ?>">
                                            <?= csrf(); ?>
                                            <div class="row mb-3">
                                                    ...
                                                    <select name="menu" class="form-control menu <?= form_error('menu', 'is-invalid '); ?>">
                                                        ...
                                                        <?php foreach ($menu as $m) : ?>
                                                            <option <?php if ($m['ID'] == $submenu['MENU_ID']) {
                                                                    ...
                                                                    } ?> value="<?= $m['ID']; ?>" <?= set_select('menu', $m['ID']) ?>><?= $m['MENU']; ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="title" class="form-control <?= form_error('title', 'is-invalid '); ?>" placeholder="Title" value="<?= $submenu['TITLE']; ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="submenu" class="form-control <?= form_error('submenu', 'is-invalid '); ?>" placeholder="Sub Menu" value="<?= $submenu['SUB_MENU']; ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="url" class="form-control <?= form_error('url', 'is-invalid '); ?>" placeholder="URL" value="<?= $submenu['URL']; ?>">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="class" class="form-control <?= form_error('class', 'is-invalid '); ?>" placeholder="Class Method" value="<?= $submenu['CLASS_METHOD']; ?>">
