                            ...
                            ?>
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                            <button class="btn btn-sm btn-primary" type="button" onclick="window.location.href = '<?= base_url('org/add'); ?>';">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="mytable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th style="width: 25px;" class="align-middle">#</th>
                                                    <th class="align-middle">Short</th>
                                                    <th style="width: 400px;" class="align-middle">Long</th>
                                                    <th class="align-middle">Parent</th>
                                                    <th class="align-middle">Status</th>
                                                    <?php if (check_button('edit') > 0 || check_button('delete') > 0) {
                                                    ?>
                                                        <th class="text-center align-middle" style="width: 75px;">Actions</th>
                                                    <?php }
                                                    ?>
                                                </tr>
                                            </thead>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#mytable').DataTable({
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?php echo site_url('org/get_data'); ?>",
                        "type": "POST"
                    },
                    'columnDefs': [{
                        "targets": [0, 4],
