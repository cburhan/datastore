<?php
class Kit_demand_tahunan_upload_model extends CI_Model
{
    ...
    {
        $this->db->select('*');
        $this->db->from('kit_demand_tahunan_upload');
    ...
    {
        $this->db->insert('kit_demand_tahunan_upload', $data);
    ...
    {
        $update = $this->db->update('kit_demand_tahunan_upload', $data, array('ID' => $file_id));
        return $update;
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('kit_demand_tahunan_upload_log');
    ...
    {
        $this->db->insert('kit_demand_tahunan_upload_log', $data_log);
    }
    ...
    public function get_not_kit($kode, $tahun)
    {
        ...
        $n = $this->db->get('kit_demand_tahunan');
        return $n;
    }
}
