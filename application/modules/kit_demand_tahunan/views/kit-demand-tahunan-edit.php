                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('kit_demand_tahunan/edit/') . encrypt_url($demand['ID']); ?>">
                                            <?= csrf(); ?>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <label for="example-text-input" class="col-sm-3 offset-sm-2 col-form-label">Kebutuhan Pembangkit Tahun</label>
                                                <div class="col-sm-7">
                                                    <p class="mt-1 mb-0 text-primary"><strong><?= $demand['TAHUN']; ?></strong></p>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                            ...
                                            <div class="mb-3 row">
                                                <div class="col-sm-10 offset-sm-1 text-center">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-warning waves-effect waves-light" onclick="window.location.href = '<?= base_url('kit_demand_tahunan'); ?>';" type="button"><i class="ion ion-md-close me-1"></i>Batal</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
