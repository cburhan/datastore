                                        ...
                                        <table id="mytable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>
                                                        <smalls>TARGET_PEMAKAIAN_BIO</smalls>
                                                    </th>
                                                    <th>
                                                        <smalls>INTENSITAS_EMISI_BIO</smalls>
                                                    </th>
                                                    <th>
                                                        <smalls>KAPASITAS_MAX_PENYIMPANAN_BIO</smalls>
                                                    </th>
                                                    <th>
                                                        <smalls>KAPASITAS_MAX_BONGKAR_HARIAN_BIO</smalls>
                                                    </th>
                                                </tr>
                                            </thead>
                                        </table>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#mytable').DataTable({
                    ...
                    "pageLength": 10,
                    "ajax": {
                        "url": "<?= site_url('kit_bio_publish/get_data_detail/') . $detail_id; ?>",
                        "type": "POST"
                    },
                    'columnDefs': [{
                        "targets": [0, 3, 4, 5, 6, 7],
