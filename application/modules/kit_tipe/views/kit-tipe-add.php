                    ...
                    <div class="page-title-box">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form method="POST" action="<?= base_url('kit_tipe/add'); ?>">
                                            <?= csrf(); ?>
                                            <div class="row mb-3">
                                                <label for="example-text-input" class="col-sm-2 offset-sm-2 col-form-label">Tipe</label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="tipe" class="form-control <?= form_error('tipe', 'is-invalid '); ?>" placeholder="Tipe" value="<?= set_value('tipe'); ?>" autofocus>
